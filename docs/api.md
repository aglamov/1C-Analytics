...
- `detailsOrientation` принимается для обратной совместимости; список детализации
  всегда выводится вертикально и прокручивается вниз;
...
типов графиков, включая круговые, линейные и площадные диаграммы. Если поле
отсутствует, применяется стандартное поведение конкретного типа графика;
круговые диаграммы по умолчанию показывают значения.
